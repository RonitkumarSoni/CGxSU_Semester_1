...
| **`GET`** | `/players/legends` | Fetch legendary football players |
| **`GET`** | `/players/meta` | Fetch current meta players |
| **`GET`** | `/players/meta/pace` | Fetch pace meta players |
| **`GET`** | `/players/meta/dribbling` | Fetch dribbling meta players |
| **`GET`** | `/players/meta/shooting` | Fetch shooting meta players |
| **`GET`** | `/players/meta/defending` | Fetch defending meta players |
| **`GET`** | `/players/meta/playstyles` | Fetch trending play styles |
| **`GET`** | `/players/export/csv` | Export player dataset as CSV |
| **`GET`** | `/players/export/json` | Export player dataset as JSON |
| **`GET`** | `/players/export/excel` | Export player dataset as Excel |
| **`GET`** | `/players/export/pdf` | Export player analytics report as PDF |
| **`POST`** | `/players/import-json` | Import player dataset using JSON |
| **`POST`** | `/players/report` | Submit player data issue report |
| **`GET`** | `/players/system/health` | Check API health status |
| **`GET`** | `/players/system/version` | Fetch API version details |
| **`GET`** | `/players/system/config` | Fetch public configuration details |
| **`POST`** | `/players/cache/clear` | Clear cached player records |
